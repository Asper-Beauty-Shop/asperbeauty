...
export const BeautyAssistant = () => {
  ...
  const translations = {
    ...
    ar: {
      ...
      welcome: "مرحباً بك في كونسيرج آسبر الفاخر. أنا الصيدلاني السريري كبير، هنا لتنظيم تجربة عناية بالبشرة شخصية بمنتجات أصلية 100% ومعتمدة من JFDA. كيف يمكنني مساعدتك اليوم؟",
