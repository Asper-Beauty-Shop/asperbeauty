...
export const ProductCard = ({ product }: ProductCardProps) => {
  ...
  const productNode = node as { tags?: string | string[]; createdAt?: string; vendor?: string };
  ...
  const createdAt = productNode.createdAt;
  ...
  const brand = productNode.vendor || node.title.split(' ')[0];
