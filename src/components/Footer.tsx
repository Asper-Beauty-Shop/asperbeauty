...
export const Footer = () => {
  ...
  return (
    <footer className="bg-secondary py-16 md:py-20 border-t border-gold/20">
          ...
          <div className="bg-background p-6 -m-2 border border-gold/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <input
                ...
                className="w-full px-4 py-3 bg-secondary border border-gold/30 text-cream font-body text-sm placeholder:text-cream/40 focus:outline-none focus:border-gold transition-colors"
                dir={isRTL ? 'rtl' : 'ltr'}
              />
              <button
                type="submit"
                className="w-full px-6 py-3 bg-gold text-background font-display text-sm tracking-wider hover:bg-gold-light transition-colors shadow-lg shadow-gold/20"
              >
                {t.subscribe}
              </button>
            </form>
