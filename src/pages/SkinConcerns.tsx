          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {skinConcerns.map((concern) => {
              ...
              return (
                <button
                  key={concern.id}
                  onClick={() => setSelectedConcern(isActive ? null : concern.id)}
                ...
                >
                  <div className="aspect-[4/3] relative">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-white">
                      ...
                      <h3 className="font-display text-xl md:text-2xl text-center mb-2">
                        {language === "ar" ? concern.nameAr : concern.nameEn}
                      </h3>
                      <p className="font-body text-sm text-white/80 text-center line-clamp-2">
